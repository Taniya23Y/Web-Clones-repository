...
document
  .querySelector(".page_2>h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;

    document.querySelector(".page_2>h1").innerHTML = clutter;
  });

gsap.to(".page_2>h1>span", {
  scrollTrigger: {
    trigger: `.page_2>h1>span`,
    start: `top bottom`,
    end: `bottom top`,
    scroller: `.main`,
    scrub: 0.5,
...
document
  .querySelector(".page_4>h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;

    document.querySelector(".page_4>h1").innerHTML = clutter;
  });

gsap.to(".page_4>h1>span", {
  scrollTrigger: {
    trigger: `.page_4>h1>span`,
    start: `top bottom`,
    end: `bottom top`,
    scroller: `.main`,
    scrub: 0.5,
...
document
  .querySelector(".page_6>h1")
  .textContent.split("")
  .forEach(function (dets) {
    clutter += `<span>${dets}</span>`;

    document.querySelector(".page_6>h1").innerHTML = clutter;
  });

gsap.to(".page_6>h1>span", {
  scrollTrigger: {
    trigger: `.page_6>h1>span`,
    start: `top bottom`,
    end: `bottom top`,
    scroller: `.main`,
    scrub: 0.5,
...
gsap.to(".page_7_circle",{
  scrollTrigger:{
    trigger: `.page_7_circle`,
    start: `top center`,
    end: `bottom top`,
    scroller: `.main`,
    scrub: 0.5
...
gsap.to(".page_7_circle_inner",{
  scrollTrigger:{
    trigger: `.page_7_circle_inner`,
    start: `top center`,
    end: `bottom top`,
    scroller: `.main`,
    scrub: 0.5
